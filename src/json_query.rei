...
let print_path_as_json_pointer:
...
let json_pointer_of_path: (~wildcards: bool=?, path) => string;
...
let path_of_json_pointer: (~wildcards: bool=?, string) => path;
...
let query: (path, Json_repr.ezjsonm) => Json_repr.ezjsonm;
...
let query_all: (path, Json_repr.ezjsonm) => list(Json_repr.ezjsonm);
...
let insert: (path, Json_repr.ezjsonm, Json_repr.ezjsonm) => Json_repr.ezjsonm;
...
let replace: (path, Json_repr.ezjsonm, Json_repr.ezjsonm) => Json_repr.ezjsonm;
...
let merge: (Json_repr.ezjsonm, Json_repr.ezjsonm) => Json_repr.ezjsonm;
  ...
  (Repr: Json_repr.Repr) =>
   {
    ...
    let query: (path, Repr.value) => Repr.value;

    /** Same as {!query_all} for a custom JSON representation. */

    let query_all: (path, Repr.value) => list(Repr.value);

    /** Same as {!insert} for a custom JSON representation. */

    let insert: (path, Repr.value, Repr.value) => Repr.value;

    /** Same as {!replace} for a custom JSON representation. */

    let replace: (path, Repr.value, Repr.value) => Repr.value;

    /** Same as {!merge} for a custom JSON representation. */

    let merge: (Repr.value, Repr.value) => Repr.value;
  };
